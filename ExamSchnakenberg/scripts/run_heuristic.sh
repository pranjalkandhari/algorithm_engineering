...
EXECUTABLE=../build/src/heuristic

REPORT_FILE=../output/heuristic_report.csv

OUT_FOLDER=../output/Track1/heuristic/
...
for FILENAME in ../input/Track1/*; do
    ...
    COMMAND="timeout ${TIMEOUT_LIMIT} ${EXECUTABLE} -gr ${FILENAME} -o ${OUTFILE}"
    OUT=$($COMMAND)
